...
if (isset($_POST['tambah_cuti'])) {
  ...
  $id_cuti = createID('id_cuti', 'cuti', 'CT');
  ...
  $sql = "INSERT INTO cuti (id_cuti, id_anggota, nama_karyawan, tanggal_mulai,tanggal_selesai,id_prov,id_kab,id_kec,keterangan, approve_oleh) 
  VALUES 
        ('$id_cuti', 
		    '$_SESSION[id_anggota]',
        '$nama_karyawan', 
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 style="text-align:center">Registrasi cuti karyawan</h3>
        <hr color="skyblue" height="20px">
        <br><br>

        <form action="cuti.php" method="post" autocomplete="off">

          <input type="text" name="tambah_cuti" hidden>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="nik" aria-describedby="addon-wrapping" name="nik" value="<?php echo " " . $_SESSION['id_anggota'] . " "; ?>" readonly style="background-color: white;"></input>
          </div>
          <br>
          ...
          <div class="text-center">
            ...
            <a href="daftarcuti.php" class="btn btn-info btn-sm btn-lg active" role="button" aria-pressed="true">Lihat daftar cuti</a>
          </div>
