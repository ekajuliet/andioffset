  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="text-center">Registrasi Izin Tidak Masuk</h3>
        <hr color="skyblue" height="20px">
        <br><br>

        <form action="ijin.php" method="post" autocomplete="off">
          ...
          <?php foreach ($ijin as $data) : ?>
            ...
            <div class="justify-content-center input-group flex-nowrap">
              <div class="input-group-prepend">
                <span class="input-group-text" id="addon-wrapping" style="width: 160px;">Bagian/Divisi</span>
              </div>
              <input type="text" class="col-7 form-control" aria-label="bagian" aria-describedby="addon-wrapping" name="bagian" required>
            </div>
            <br>

            <div class="justify-content-center input-group flex-nowrap">
              <div class="input-group-prepend">
                <span class="input-group-text" id="addon-wrapping" style="width: 160px;">Alasan</span>
              </div>
            ...
            <div class="text-center">
              ...
              <a href="daftarijin.php" class="btn btn-info btn-sm btn-lg active" role="button" aria-pressed="true">Lihat daftar ijin</a>
            </div>
