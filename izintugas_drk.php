...
include 'koneksi.php';
$no = 1;
$tugas = query("SELECT nik, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
kabupaten.nama as kabupaten, kecamatan.nama as kecamatan, status FROM tugas 
...
<head>
    ...
    <title>Informasi izin tugas</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Informasi Izin Tugas Karyawan</h4>
                                ...
                                <?php foreach ($tugas as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>    
                                            <a href="approvetugas.php?id=<?= $data["id"]; ?>" onclick="return confirm('apakah anda yakin ingin menerima izin tugas berikut?');" type="submit" name="back">
                                                <button class="btn btn-success btn-sm" type="button">approve</button>
                                            </a>
                                            
                                            <a href="refusetugas.php?id=<?= $data["id"]; ?>" onclick="return confirm('apakah anda yakin ingin menolak izin tugas berikut?');" type="submit" name="back">
