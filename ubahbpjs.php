...
$id = $_GET["id"];
$ubahbpjs = query("SELECT * FROM tunjangan WHERE id_tunjangan = '$id'");
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="id" value="<?= $ubahbpjs["id_tunjangan"]; ?>">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $ubahbpjs[0]["id_anggota"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="nama_anggota" aria-describedby="addon-wrapping" name="nama_anggota" id="nama_anggota" value="<?= $ubahbpjs[0]["nama_anggota"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="nomor_ktp" style="width: 160px;">Nomor KTP</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="nomor_ktp" aria-describedby="addon-wrapping" name="nomor_ktp" id="nomor_ktp" value="<?= $ubahbpjs[0]["nomor_ktp"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="no_telp" style="width: 160px;">Nomor Telp</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="no_telp" aria-describedby="addon-wrapping" name="no_telp" id="no_telp" value="<?= $ubahbpjs[0]["no_telp"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="jenis_kelamin" style="width: 160px;">Jenis Kelamin</span>
                        </div>
                        <select type="text" class="col-7 form-control" aria-label="jenis_kelamin" aria-describedby="addon-wrapping" name="jenis_kelamin" id="jenis_kelamin" value="<?= $ubahbpjs[0]["jenis_kelamin"]; ?>" required>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="tanggal_lahir" aria-describedby="addon-wrapping" name="tanggal_lahir" id="tanggal_lahir" value="<?= $ubahbpjs[0]["tanggal_lahir"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="kelas" style="width: 160px;">Kelas</span>
                        </div>
                        <select type="text" class="col-7 form-control" aria-label="kelas" aria-describedby="addon-wrapping" name="kelas" id="kelas" value="<?= $ubahbpjs[0]["kelas"]; ?>" required>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="gaji" style="width: 160px;">Gaji</span>
                        </div>
                        <select type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="gaji" id="gaji" value="<?= $ubahbpjs[0]["gaji"]; ?>" required>
                            <option>
                    ...
                    <div class="text-center">
                        ...
                        <a href="bpjs_admin.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
