...
if (isset($_POST["tambah_transport"])) {
    $id_tunjangan   = createID('id_transport', 'tunjangan_transport', 'TT');
    ...
    $sql = "INSERT INTO tunjangan_transport(id_transport,id_anggota,nama_anggota,status_dapat,status_terima, keterangan) VALUES (
                '$id_tunjangan',
                '$id_anggota',
                '$nama_anggota',
                '$status_dapat',
...
<head>
    ...
    <title>Tunjangan Transportasi</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Tambah Tunjangan Transportasi</h4>
                <hr color="skyblue" height="20px">
                <br><br>

                <form action="" method="post">

                    <input type="text" name="tambah_transport" hidden>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" style="background-color: white;"></input>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="nama_anggota" aria-describedby="addon-wrapping" name="nama_anggota" style="background-color: white;"></input>
                    </div>
                    <br>
