...
$cuti = query("SELECT id_anggota, status, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, approve_oleh, provinsi.nama as provinsi, 
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="container">
          <h3 style="text-align: center">Daftar Cuti Karyawan</h3>
          <br><br>
          ...
          <form action="" method="POST">
            ...
            <?php foreach ($cuti as $data) : ?>
              ...
              <div class="card mb-5">
                ...
                <div class="card-body">
                  <p class="card-title">Tanggal Mulai Cuti &nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["tanggal_mulai"]; ?></p>
                  <p class="card-title">Tanggal Selesai Cuti &nbsp;: <?php echo $data["tanggal_selesai"]; ?></p>
                  <p class="card-title">Provinsi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["provinsi"]; ?></p>
                  <p class="card-title">Kabupaten &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["kabupaten"]; ?></p>
                  <p class="card-title">Kecamatan &nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["kecamatan"]; ?>
                  </p>
                  <p class="card-title">keterangan &nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["keterangan"]; ?>
                  </p>
                  <p class="card-title">Approve Oleh &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $data["approve_oleh"]; ?>
                  </p>

                  <br>
                  <p style="text-align: left;font-weight:bold" ;>Status cuti :
                    <?php if ($data['status'] == "approve") { ?>
                      <button type="button" class="btn btn-success btn-sm"><?php echo $data['status']; ?></button>
                    <?php } else if ($data['status'] == "pending") { ?>
                      <button type="button" class="btn btn-warning btn-sm"><?php echo $data['status']; ?></button>
                    <?php } else { ?>
                      <button type="button" class="btn btn-danger btn-sm"><?php echo $data['status']; ?></button>
                    <?php }
                    ?>
