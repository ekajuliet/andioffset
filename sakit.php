...
$sakit = query("SELECT id_sakit,id_anggota,nama_karyawan,tanggal_sekarang,nama_dokter,keterangan,foto FROM sakit

WHERE id_anggota = '" . $_SESSION['id_anggota'] . "'

ORDER BY id_sakit DESC");
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="container">
          <h3 style="text-align: center">Daftar Izin Sakit Karyawan</h3>
          <br><br>
          ...
          <form action="" method="POST">
            ...
            <?php foreach ($sakit as $data) : ?>
              ...
              <div class="card mb-5">
                ...
                <div class="card-body">
                  <p class="card-title">Tanggal Sakit &nbsp;&nbsp;&nbsp;: <?php echo $data["tanggal_sekarang"]; ?></p>
                  <p class="card-title">Nama Dokter &nbsp;&nbsp;&nbsp;: <?php echo $data["nama_dokter"]; ?></p>
                  <p class="card-title">Keterangan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["keterangan"]; ?></p>
                  <p class="card-title">File &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["foto"]; ?>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <p>Download File&nbsp;&nbsp; :&nbsp;&nbsp;&nbsp; <a href="download.php?filename=<?= $data['foto'] ?>" type="submit"><i class="fas fa-file-download" style="font-size: 22px"></i></a>
                    </p>
                    <br>
                </div>
              </div>
