...
$no = 1;
$beras = query("SELECT * FROM tunjangan_beras ORDER BY id_beras DESC");
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi Beras</h4>
                        ...
                        <table id="example" class="display table-bordered text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 100px">ID Anggota</th>
                                    <th style="width: 150px">Nama Anggota</th>
                                    <th style="width: 150px">Status Dapat</th>
                                    <th style="width: 150px">Status Terima</th>
                                    <th style="width: 250px">Keterangan</th>
                                </tr>
                            </thead>

                            <tbody>
                                <?php foreach ($beras as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapusberas.php?id=<?= $data["id_beras"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="tambahberas_admin.php?id=<?= $data["id_beras"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
                                                <i class='far fa-edit' style="font-size: 18px; color:white"></i>
                                            </a>
                                        </td>
                                        <td><?php echo $data["id_anggota"]; ?></td>
                                        <td><?php echo $data["nama_anggota"]; ?></td>
                                        <td><?php echo $data["status_dapat"]; ?></td>
                                        <td><?php echo $data["status_terima"]; ?></td>
