...
//Application Title
define('APP_TITLE', 'HRIS Andi File Manager');
...
$auth_users = array(
    'hris' => '$2y$10$jV154De5qNmwfQI2OfNCY.h.t/mpI3jMMV8vFVIdpBb2iVpD3.KHe'
);
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/projekandiofset1';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/projekandiofset1';
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            ...
                                            <center><h1 style="font-weight: 700; border-bottom: 1px solid grey">HRIS</h1></center>
                                        </div>
