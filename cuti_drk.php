...
include 'koneksi.php';
$no = 1;
$cuti = query("SELECT nik, id, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
kabupaten.nama as kabupaten, kecamatan.nama as kecamatan, status FROM cuti 
                        ...
                        <table id="example" class="display table-bordered text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 50px">Tanggal mulai</th>
                                    <th style="width: 50px">Tanggal selesai</th>
                                ...
                                <?php foreach ($cuti as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>    
                                            <a href="approvecuti.php?id=<?= $data["id"]; ?>" onclick="return confirm('apakah anda yakin ingin menerima izin cuti berikut?');" type="submit" name="back">
                                                <button class="btn btn-success btn-sm" type="button">approve</button>
                                            </a>
                                            
                                            <a href="refusecuti.php?id=<?= $data["id"]; ?>" onclick="return confirm('apakah anda yakin ingin menolak izin cuti berikut?');" type="submit" name="back">
