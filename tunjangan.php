    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Informasi Pengajuan</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='fas fa-tshirt' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI SERAGAM</h6>
                                </div>
                                <div class="card-header">
                                    <a href="infoseragam_admin.php" style="color: white">
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:purple">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='fab fa-blackberry' style='font-size:50px'></i></h6>
                                    <h6 class="card-text" style="font-size: 15px">INFORMASI BERAS</h6>
                                </div>
                                <div class="card-header">
                                    <a href="infoberas_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='fas fa-car-side' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI TRANSPORTASI</h6>
                                </div>
                                <div class="card-header">
                                    <a href="infotranspor_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='far fa-clone' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI BPJS KESEHATAN</h6>
                                </div>
                                <div class="card-header">
                                    <a href="bpjskesehatan_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:orange">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-text">BPJS KETENAGAKERJAAN</h6>
                                </div>
                                <div class="card-header">
                                    <a href="bpjs_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:coral">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='far fa-folder-open' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI BPJS HARI TUA</h6>
                                </div>
                                <div class="card-header">
                                    <a href="bpjspensiun_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
