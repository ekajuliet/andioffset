...
$daftarsakit = query("SELECT * FROM user 

 WHERE id_anggota = '" . $_SESSION['id_anggota'] . "'");

if (isset($_POST["submit"])) {

  if (tambahijinsakit($_POST) > 0) {
    echo "
      <script>
        alert('data berhasil ditambah');
        document.location.href = 'daftarsakit.php';
      </script>
      ";
  } else {
    echo "
...
<head>
  ...
  <title>Daftar Sakit Karyawan</title>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="text-center">Izin Sakit Karyawan</h3>
        <hr color="skyblue" height="20px">
        <br><br>

        <form action="daftarsakit.php" method="post" enctype="multipart/form-data" autocomplete="off">

          <?php foreach ($daftarsakit as $data) : ?>
            ...
            <div class="justify-content-center input-group flex-nowrap">
              ...
              <input type="text" class="col-7 form-control" aria-label="nama_karyawan" aria-describedby="addon-wrapping" name="nama_karyawan" value="<?php echo $data["nama_anggota"]; ?>" readonly style="background-color: white;"></input>
            </div>
            <br>
            ...
            <div class="justify-content-center input-group flex-nowrap">
              ...
              <input type="text" class="col-7 form-control" aria-label="nama_dokter" aria-describedby="addon-wrapping" name="nama_dokter">
            </div>
            <br>
            ...
            <div class="text-center">
              Masukkan surat keterangan dokter <br>berupa file gambar (jpg,jpeg,png)
              <br><br>
              <input type="file" name="foto" for="foto" id="foto"></input>
            </div>
            <br>
            <br>
            ...
            <div class="text-center">
              ...
              <a href="sakit.php" class="btn btn-info btn-sm btn-lg active" role="button" aria-pressed="true">Lihat daftar sakit</a>
            </div>
