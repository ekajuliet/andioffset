...
$seragam = query("SELECT * FROM tunjangan_seragam 

  WHERE id_anggota = '" . $_SESSION['id_anggota'] . "'
  ORDER BY id_seragam DESC");
  ...
  <div class="d-flex" id="wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div class=pengajuan>
          <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
            <div class="text-light d-flex w-100 justify-content-start align-items-center">
              ...
              <span class="menu-collapsed">&nbsp;&nbsp;&nbsp;Pengajuan</span>
        ...
        <div class=Tunjangan>
          <a href="#submenu3" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
            <div class="text-light d-flex w-100 justify-content-start align-items-center">
              <span class='fas fa-file' style='font-size:20px'></span>
              <span class="menu-collapsed">&nbsp;&nbsp;&nbsp;Tunjangan</span>
              <span class="submenu-icon ml-auto"></span>
            </div>
          </a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 class="text-center">Informasi Seragam</h3>
        <br><br>

        <form action="" method="get">

          <?php foreach ($seragam as $data) : ?>
            <div class="card mb-5">

            <h5 class="card-header"><?php echo $data["nama_anggota"]; ?> (<?php echo $data["id_anggota"]; ?>)</h5>
            <div class="card-body">
              <p class="card-title">Status Dapat &nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["status_dapat"]; ?></p>
              <p class="card-title">Kemeja &nbsp;: <?php echo $data["kemeja"]; ?></p>
              <p class="card-title">Celana &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["celana"]; ?></p>
              <p class="card-title">Status Terima &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["status_terima"]; ?></p>
