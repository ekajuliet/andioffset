...
$no = 1;
$transport = query("SELECT * FROM tunjangan_transport ORDER BY id_transport DESC");
                ...
                <form action="" method="POST">
                    ...
                    <div class="container">
                        ...
                        <table id="example" class="display table-bordered text-center">
                            ...
                            <tbody>
                                <?php foreach ($transport as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapustransport.php?id=<?= $data["id_transport"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="tambahtransport_admin.php?id=<?= $data["id_transport"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
