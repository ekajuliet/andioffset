...
$ijin = query("SELECT id_ijin, id_anggota, nama_karyawan, tanggal_sekarang, bagian, alasan FROM ijin 
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="container">
          <h3 style="text-align: center">Daftar Izin Tidak Masuk</h3>
          <br><br>
          ...
          <form action="" method="POST">
            ...
            <?php foreach ($ijin as $data) : ?>
              ...
              <div class="card mb-5">
                ...
                <div class="card-body">
                  <p class="card-title">Tanggal Sekarang &nbsp;&nbsp;&nbsp;: <?php echo $data["tanggal_sekarang"]; ?></p>
                  <p class="card-title">Bagian/Divisi &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;: <?php echo $data["bagian"]; ?></p>
