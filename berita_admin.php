    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Berita Karyawan</h4>
                                ...
                                <?php foreach ($berita as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapusberita.php?id=<?= $data["id_berita"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="ubahberita_admin.php?id=<?= $data["id_berita"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
