...
$ubahseragam = query("SELECT * FROM tunjangan_seragam WHERE id_seragam = '$id'");

if (isset($_POST["daftar"])) {
  if (ubahseragam($_POST) > 0) {
    echo "
      <script>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <h4 class="text-center">Ubah Tunjangan Seragam</h4>
        ...
        <form action="" method="post" autocomplete="off">
          ...
          <input type="hidden" name="id" value="<?= $ubahseragam["id_anggota"]; ?>">
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $ubahseragam[0]["id_anggota"]; ?>" required>
          </div>
          <br>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="nama_anggota" aria-describedby="addon-wrapping" name="nama_anggota" id="nama_anggota" value="<?= $ubahseragam[0]["nama_anggota"]; ?>" required>
          </div>
          <br>

          <div class="justify-content-center input-group flex-nowrap">
            <div class="input-group-prepend">
              <span class="input-group-text" id="addon-wrapping" for="status_dapat" style="width: 160px;">Status Dapat</span>
            </div>
            <input type="text" class="col-7 form-control" aria-label="status_dapat" aria-describedby="addon-wrapping" name="status_dapat" id="status_dapat" value="<?= $ubahseragam[0]["status_dapat"]; ?>" required>
          </div>
          <br>

          <div class="justify-content-center input-group flex-nowrap">
            <div class="input-group-prepend">
              <span class="input-group-text" id="addon-wrapping" for="kemeja" style="width: 160px;">Kemeja</span>
            </div>
            <input type="text" class="col-sm-7 form-control" aria-label="kemeja" aria-describedby="addon-wrapping" name="kemeja" id="kemeja" value="<?= $ubahseragam[0]["kemeja"]; ?>" required>
          </div>
          <br>

          <div class="justify-content-center input-group flex-nowrap">
            <div class="input-group-prepend">
              <span class="input-group-text" id="addon-wrapping" for="celana" style="width: 160px;">Celana</span>
            </div>
            <input type="text" class="col-sm-7 form-control" aria-label="celana" aria-describedby="addon-wrapping" name="celana" id="celana" value="<?= $ubahseragam[0]["celana"]; ?>" required>
          </div>
          <br>

          <div class="justify-content-center input-group flex-nowrap">
            <div class="input-group-prepend">
              <span class="input-group-text" id="addon-wrapping" for="status_terima" style="width: 160px;">Status Terima</label>
            </div>
            <input type="text" class="col-sm-7 form-control" aria-label="status_terima" aria-describedby="addon-wrapping" name="status_terima" id="status_terima" value="<?= $ubahseragam[0]["status_terima"]; ?>" required>
          </div>
          <br>

          <div class="justify-content-center input-group flex-nowrap">
            <div class="input-group-prepend">
              <span class="input-group-text" id="addon-wrapping" for="keterangan" style="width: 160px;">Keterangan</label>
            </div>
            <input type="text" class="col-sm-7 form-control" aria-label="keterangan" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $ubahseragam[0]["keterangan"]; ?>" required>
          </div>
          <br>

          <div class="style1 text-center">
            <input type="submit" class="btn btn-info" name="daftar" value="ubah">
            <a href="infoseragam_admin.php" type="submit" class="btn btn-success" name="back">Kembali</a>
          </div>
        </form>
      </div>
