...
$edit = query("SELECT * FROM tunjangan_transport WHERE id_transport = '$id'");

if (isset($_POST["daftar"])) {
    if (ubahtransport($_POST) > 0) {
        echo "
      <script>
            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $edit[0]["id_anggota"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="nama_anggota" aria-describedby="addon-wrapping" name="nama_anggota" id="nama_anggota" value="<?= $edit[0]["nama_anggota"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="status_dapat" aria-describedby="addon-wrapping" name="status_dapat" id="status_dapat" value="<?= $edit[0]["status_dapat"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="status_terima" style="width: 160px;">Status Terima</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="status_terima" aria-describedby="addon-wrapping" name="status_terima" id="status_terima" value="<?= $edit[0]["status_terima"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="keterangan" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $edit[0]["keterangan"]; ?>" required>
                    </div>
                    <br><br>
