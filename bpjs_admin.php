...
$bpjs_ketenagakerjaan = query("SELECT * FROM tunjangan ORDER BY id_tunjangan DESC");
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi BPJS Ketenagakerjaan</h4>
                ...
                <form action="" method="POST">
                    ...
                    <div class="container">
                        ...
                        <table id="example" class="display table-bordered text-center">
                            ...
                            <tbody>
                                <?php foreach ($bpjs_ketenagakerjaan as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapusbpjs.php?id=<?= $data["id_tunjangan"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="ubahbpjs.php?id=<?= $data["id_tunjangan"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
