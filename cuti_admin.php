...
$cuti = query("SELECT cuti.id_cuti as idcuti, id_cuti,id_anggota, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
                                ...
                                <?php foreach ($cuti as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapuscuti.php?id=<?php echo $data['id_cuti']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="ubahcuti_admin.php?id=<?php echo $data['id_cuti']; ?>" type="submit" class="btn btn-info btn-sm" name="back">
