...
$id = $_GET["id"];
$ubahberita = query("SELECT * FROM berita WHERE id = $id")[0];
...
if (isset($_POST["daftar"])) {
    if (ubahberita($_POST) > 0) {
      ...
      <script>
        ...
        document.location.href = 'berita_drk.php';
      </script>
      ";
    } else {
        echo "
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="id" value="<?= $ubahberita["id"]; ?>">

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="nip">NIP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="nip" id="nip" value="<?= $ubahberita["nip"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="tanggal_sekarang" id="tanggal_sekarang" value="<?= $ubahberita["tanggal_sekarang"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="judul">Judul&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="judul" id="judul" value="<?= $ubahberita["judul"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <textarea type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="keterangan" rows="5" cols="5" id="keterangan" required><?= $ubahberita["keterangan"]; ?></textarea>
                    </div>
                    <br><br>

                    <div class="text-center">
                        <input type="submit" class="btn btn-info" name="daftar" value="ubah">
                        <a href="berita_drk.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
                </form>
            </div>
