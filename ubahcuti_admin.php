...
$ubahcuti = query("SELECT cuti.id_cuti as idcuti, id_anggota, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Informasi Cuti Karyawan</h4>
                <hr color="skyblue" height="20px">
                <br><br>

                <form action="" method="post" autocomplete="off">

                    <input type="hidden" name="id" value="<?= $ubahcuti["id_anggota"]; ?>">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $ubahcuti[0]["id_anggota"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="nama_karyawan" aria-describedby="addon-wrapping" name="nama_karyawan" id="nama_karyawan" value="<?= $ubahcuti[0]["nama_karyawan"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="tanggal_mulai" aria-describedby="addon-wrapping" name="tanggal_mulai" id="tanggal_mulai" value="<?= $ubahcuti[0]["tanggal_mulai"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="tanggal_selesai" aria-describedby="addon-wrapping" name="tanggal_selesai" id="tanggal_selesai" value="<?= $ubahcuti[0]["tanggal_selesai"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="provinsi" aria-describedby="addon-wrapping" name="provinsi" id="provinsi" id="provinsi" value="<?= $ubahcuti[0]["provinsi"]; ?>" required>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="kabupaten" aria-describedby="addon-wrapping" name="kabupaten" id="kabupaten" id="kabupaten" value="<?= $ubahcuti[0]["kabupaten"]; ?>" required>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="kecamatan" aria-describedby="addon-wrapping" name="kecamatan" id="kecamatan" id="kecamatan" value="<?= $ubahcuti[0]["kecamatan"]; ?>">
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="keterangan" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $ubahcuti[0]["keterangan"]; ?>" required></input>
                    </div>
                    <br>
