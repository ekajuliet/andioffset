...
<head>
    ...
    <title>Izin tidak masuk Karyawan</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi Izin Tidak Masuk Karyawan</h4>
                        ...
                        <table id="example" class="display table-bordered text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 150px">Tanggal Sekarang</th>
                                    <th style="width: 150px">Bagian/Divisi</th>
                                    <th style="width: 250px">Alasan Izin</th>
                                </tr>
                            </thead>
                                ...
                                <?php foreach ($ijin as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapusijin.php?id=<?= $data["id_ijin"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="tambahijin_admin.php?id=<?= $data["id_ijin"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
