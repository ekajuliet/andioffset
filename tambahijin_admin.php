...
$tambahijin = query("SELECT * FROM ijin WHERE id_ijin = '$id'");
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="id" value="<?= $tambahijin["id_ijin"]; ?>">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $tambahijin[0]["id_anggota"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="nama_karyawan" aria-describedby="addon-wrapping" name="nama_karyawan" id="nama_karyawan" value="<?= $tambahijin[0]["nama_karyawan"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="tanggal_sekarang" aria-describedby="addon-wrapping" name="tanggal_sekarang" id="tanggal_sekarang" value="<?= $tambahijin[0]["tanggal_sekarang"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="bagian" style="width: 160px;">Bagian/Divisi</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="bagian" aria-describedby="addon-wrapping" name="bagian" id="bagian" value="<?= $tambahijin[0]["bagian"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="alasan" style="width: 160px;">Keterangan</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="alasan" aria-describedby="addon-wrapping" name="alasan" id="alasan" value="<?= $tambahijin[0]["alasan"]; ?>" required>
                    </div>
                    <br><br>

                    <div class="style1 text-center">
                        <input type="submit" class="btn btn-info" name="daftar" value="ubah">
                        <a href="ijinkaryawan_admin.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
                </form>
            </div>
