...
$ubahberas = query("SELECT * FROM tunjangan_beras WHERE id_beras = '$id'");

if (isset($_POST["daftar"])) {
  if (ubahberas($_POST) > 0) {
    echo "
      <script>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <h4 class="text-center">Ubah Tunjangan Beras</h4>
        ...
        <form action="" method="post" autocomplete="off">
          ...
          <input type="hidden" name="id" value="<?= $ubahberas["id_anggota"]; ?>">
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $ubahberas[0]["id_anggota"]; ?>" required>
          </div>
          <br>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="nama_anggota" aria-describedby="addon-wrapping" name="nama_anggota" id="nama_anggota" value="<?= $ubahberas[0]["nama_anggota"]; ?>" required>
          </div>
          <br>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-7 form-control" aria-label="status_dapat" aria-describedby="addon-wrapping" name="status_dapat" id="status_dapat" value="<?= $ubahberas[0]["status_dapat"]; ?>" required>
          </div>
          <br>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-sm-7 form-control" aria-label="status_terima" aria-describedby="addon-wrapping" name="status_terima" id="status_terima" value="<?= $ubahberas[0]["status_terima"]; ?>" required>
          </div>
          <br>
          ...
          <div class="justify-content-center input-group flex-nowrap">
            ...
            <input type="text" class="col-sm-7 form-control" aria-label="keterangan" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $ubahberas[0]["keterangan"]; ?>" required>
          </div>
          <br>
