...
if (isset($_POST["tambah_beras"])) {
  $id_tunjangan   = createID('id_beras', 'tunjangan_beras', 'TT');
  ...
  $sql = "INSERT INTO tunjangan_beras(id_beras,id_anggota,nama_anggota,status_dapat,status_terima, keterangan) VALUES (
                '$id_tunjangan',
                '$id_anggota',
                '$nama_anggota',
                '$status_dapat',
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h4 class="text-center">Tambah Tunjangan Beras</h4>
        <hr color="skyblue" height="20px">
        <br><br>

        <form action="" method="post">

          <input type="text" name="tambah_beras" hidden>
