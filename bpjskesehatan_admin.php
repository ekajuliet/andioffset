...
$bpjs_kesehatan = query("SELECT * FROM tunjangan ORDER BY id_tunjangan DESC");
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi BPJS Kesehatan</h4>
                ...
                <form action="" method="POST">
                    ...
                    <div class="container">
                        ...
                        <table id="example" class="display table-bordered text-center">
                            ...
                            <tbody>
                                <?php foreach ($bpjs_kesehatan as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
