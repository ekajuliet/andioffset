...
$ubahsakit = query("SELECT * FROM sakit WHERE id_anggota = '$id'");

if (isset($_POST["daftar"])) {
    if (ubahsakit($_POST) > 0) {
        echo "
        <script>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Ubah Izin Sakit Karyawan</h4>
                ...
                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <input type="hidden" name="id" value="<?= $ubahsakit["id_anggota"]; ?>">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="id_anggota" aria-describedby="addon-wrapping" name="id_anggota" id="id_anggota" value="<?= $ubahsakit[0]["id_anggota"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="nama_karyawan" style="width: 160px;">Nama Anggota</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="nama_karyawan" aria-describedby="addon-wrapping" name="nama_karyawan" id="nama_karyawan" value="<?= $ubahsakit[0]["nama_karyawan"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="tanggal_sekarang" style="width: 160px;">Tanggal Sakit</span>
                        </div>
                        <input type="date" class="col-7 form-control" aria-label="tanggal_sekarang" aria-describedby="addon-wrapping" name="tanggal_sekarang" id="tanggal_sekarang" value="<?= $ubahsakit[0]["tanggal_sekarang"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="nama_dokter" style="width: 160px;">Nama Dokter</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="nama_dokter" aria-describedby="addon-wrapping" name="nama_dokter" id="nama_dokter" value="<?= $ubahsakit[0]["nama_dokter"]; ?>" required>
                    </div>
                    <br>

                    <div class="justify-content-center input-group flex-nowrap">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="addon-wrapping" for="keterangan" style="width: 160px;">Keterangan Sakit</span>
                        </div>
                        <input type="text" class="col-7 form-control" aria-label="keterangan" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $ubahsakit[0]["keterangan"]; ?>" required></input>
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="text-center">
                        ...
                        <a href="izinsakit_admin.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
                </form>
                <br><br><br><br>
            </div>
