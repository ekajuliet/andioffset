...
$tugas = query("SELECT id_anggota, status, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h3 style="text-align: center">Daftar Tugas Karyawan</h3>
        <br>
            ...
            <div class="card mb-5">
              ...
              <div class="card-body">
                ...
                <p class="card-title">Kecamatan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $data["kecamatan"]; ?></p>
                <p class="card-title">keterangan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                  <p style="color: blue" style="font-weight: bold"><?php echo $data["keterangan"]; ?></p>
                </p>
                <br>
                <p style="text-align: left;font-weight:bold" ;>Status tugas :
