...
$ubahcuti = query("SELECT * FROM cuti WHERE id = $id")[0];
...
if (isset($_POST["daftar"])) {
    if (ubahcuti($_POST) > 0) {
      ...
      <script>
        ...
        document.location.href = 'cuti_drk.php';
      </script>
      ";
    } else {
        echo "
            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="text-center">
                        ...
                        <a href="cuti_drk.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
                </form>
                </div>
