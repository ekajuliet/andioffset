...
$tambah = query("SELECT * FROM karyawan 
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    <a href="cuti_drk.php" style="text-decoration:none">
                        <div class="alert alert-primary" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-file-alt' style='font-size:40px'></i></h6>
                            <h6 class="text-center">INFORMASI CUTI KARYAWAN</h6>
                        </div>
                    </a>

                    <a href="ijinkaryawan_drk.php" style="text-decoration:none">
                        <div class="alert alert-secondary" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-copy' style='font-size:40px'></i></h6>
                            <h6 class="text-center">INFORMASI IZIN TIDAK MASUK KARYAWAN</h6>
                        </div>
                    </a>

                    <a href="izintugas_drk.php" style="text-decoration:none">
                        <div class="alert alert-success" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-folder-open' style='font-size:40px'></i></h6>
                            <h6 class="text-center">INFORMASI IZIN TUGAS KARYAWAN</h6>
                        </div>
                    </a>

                    <a href="izinsakit_drk.php" style="text-decoration:none">
                        <div class="alert alert-danger" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-clone' style='font-size:40px'></i></h6>
                            <h6 class=" text-center">INFORMASI IZIN SAKIT KARYAWAN</h6>
                        </div>
                    </a>

                    <a href="bpjs_drk.php" style="text-decoration:none">
                        <div class="alert alert-warning" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-file-alt' style='font-size:40px'></i></h6>
                            <h6 class=" text-center">INFORMASI BPJS KARYAWAN</h6>
                        </div>
                    </a>

                    <a href="berita_drk.php" style="text-decoration:none">
                        <div class="alert alert-dark" role="alert" style="height: 130px">
                            <br>
                            <h6 class="text-center"><i class='far fa-copy' style='font-size:40px'></i></h6>
                            <h6 class=" text-center">INFORMASI BERITA</h6>
                        </div>
                    </a>
                </div>
            </div>
