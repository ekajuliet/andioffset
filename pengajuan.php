                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-text">INFORMASI IZIN TIDAK MASUK</h6>
                                </div>
                                <div class="card-header">
                                    <a href="ijinkaryawan_admin.php" style="color: white">
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:purple">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-text" style="font-size: 15px">INFORMASI IZIN KELUAR</h6>
                                </div>
                                <div class="card-header">
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-text">INFORMASI IZIN TERLAMBAT</h6>
                                </div>
                                <div class="card-header">
                                    <a href="#" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="card-text">INFORMASI CUTI</h6>
                                </div>
                                <div class="card-header">
                                    <a href="cuti_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:orange">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='far fa-file-alt' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI IZIN SAKIT</h6>
                                </div>
                                <div class="card-header">
                                    <a href="izinsakit_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-white mb-3" style="max-width: 18rem;background-color:coral">
                                <div class="card-body text-center">
                                    <h6 class="card-title"><i class='far fa-copy' style='font-size:50px'></i></h6>
                                    <h6 class="card-text">INFORMASI IZIN TUGAS DINAS</h6>
                                </div>
                                <div class="card-header">
                                    <a href="izintugas_admin.php" style="color: white">
                                        <i class="fas fa-arrow-alt-circle-right" style='font-size:30px'></i>
                                    </a>
                                </div>
                            </div>
