...
$ubahcuti = query("SELECT nik, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
kabupaten.nama as kabupaten, kecamatan.nama as kecamatan FROM cuti 
INNER JOIN provinsi ON cuti.id_prov = provinsi.id_prov
INNER JOIN kabupaten ON cuti.id_kab = kabupaten.id_kab
INNER JOIN kecamatan ON cuti.id_kec = kecamatan.id_kec
WHERE id = $id")[0];
    ...
    <div class="d-flex" id="wrapper">
        <div class="text-light bg-dark border-right" id="sidebar-wrapper">
            <div class="list-group list-group-flush">
                ...
                <a href="berita_admin.php" class="text-light nav-link ml-auto list-group-item list-group-item-action bg-dark"><i class='fas fa-paper-plane' style='font-size:20px'></i>&nbsp;&nbsp;&nbsp;Berita</a>
                <a href="berita_admin.php" class="text-light nav-link ml-auto list-group-item list-group-item-action bg-dark"><i class='far fa-comments' style='font-size:20px'></i>&nbsp;&nbsp;&nbsp;Kritik/Saran</a>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center">Ubah Cuti Karyawan</h4>
                <hr color="skyblue" height="20px">
                <br><br>

                <form action="" method="post" autocomplete="off">

                    <input type="hidden" name="id" value="<?= $ubahcuti["id"]; ?>">
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="nik" id="nik" value="<?= $ubahcuti["nik"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="nama_karyawan" id="nama_karyawan" value="<?= $ubahcuti["nama_karyawan"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="tanggal_mulai" id="tanggal_mulai" value="<?= $ubahcuti["tanggal_mulai"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="date" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="tanggal_selesai" id="tanggal_mulai" value="<?= $ubahcuti["tanggal_mulai"]; ?>" required>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="provinsi" id="provinsi" id="provinsi" value="<?= $ubahcuti["provinsi"]; ?>" required>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="kabupaten" id="kabupaten" id="kabupaten" value="<?= $ubahcuti["kabupaten"]; ?>" required>
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <select class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="kecamatan" id="kecamatan" id="kecamatan" value="<?= $ubahcuti["kecamatan"]; ?>">
                        </select>
                    </div>
                    <br>
                    ...
                    <div class="justify-content-center input-group flex-nowrap">
                        ...
                        <input type="text" class="col-7 form-control" aria-label="Username" aria-describedby="addon-wrapping" name="keterangan" id="keterangan" value="<?= $ubahcuti["keterangan"]; ?>" required></input>
                    </div>
                    <br><br>

                    <div class="text-center">
                        <input type="submit" class="btn btn-info" name="daftar" value="ubah">
                        <a href="cuti_admin.php" type="submit" class="btn btn-success" name="back">Kembali</a>
                    </div>
                </form>
                </div>
