...
$sakit = query("SELECT * FROM sakit ORDER BY id_sakit DESC");
...
<head>
    ...
    <title>Informasi sakit karyawan</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi sakit Karyawan</h4>
                                ...
                                <?php foreach ($sakit as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapussakit.php?id=<?= $data["id_sakit"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="download.php?filename=<?= $data['foto'] ?>" type="submit">
                                                <i class="btn btn-success btn-sm"><i class="fas fa-file-download" style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="ubahsakit_admin.php?id=<?= $data["id_anggota"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
                                                <i class='far fa-edit' style="font-size: 18px; color:white"></i>
                                            </a>
                                        </td>
                                        <td><?php echo $data["id_anggota"]; ?></td>
                                        <td><?php echo $data["nama_karyawan"]; ?></td>
                                        <td><?php echo $data["tanggal_sekarang"]; ?></td>
