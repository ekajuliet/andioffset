...
$tugas = query("SELECT tugas.id_tugas as idtugas, id_anggota, keterangan, nama_karyawan, tanggal_mulai, tanggal_selesai, provinsi.nama as provinsi, 
                                ...
                                <?php foreach ($tugas as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapustugas.php?id=<?php echo $data['idtugas']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="ubahtugas_admin.php?id=<?php echo $data['idtugas']; ?>" type="submit" class="btn btn-info btn-sm" name="back">
