...
$no = 1;
$seragam = query("SELECT * FROM tunjangan_seragam ORDER BY id_seragam DESC");
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="text-center">Informasi Seragam</h4>
                                ...
                                <?php foreach ($seragam as $data) : ?>
                                    <tr>
                                        <td><?php echo $no;
                                            $no++; ?></td>
                                        <td>
                                            <a href="hapusseragam.php?id=<?= $data["id_seragam"]; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?');" type="submit" name="back">
                                                <i class="btn btn-danger btn-sm"><i class='far fa-trash-alt' style="font-size: 18px; color:white"></i></i>
                                            </a>

                                            <a href="tambahseragam_admin.php?id=<?= $data["id_seragam"]; ?>" type="submit" class="btn btn-info btn-sm" name="back">
